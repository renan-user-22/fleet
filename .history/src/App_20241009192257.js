  ...
  return (
    <Container>
      ...
      <FleetSection id="fleet">
        ...
        >
         Na Fleet Solutions, somos especialistas em direito detrânsito, 
         oferecendo uma ampla gama de serviços tantopara motoristas quanto 
         para empresas (B2B e B2C).Atuamos na defesa de multas, cassação e suspensão deCNH, 
         além de fornecer soluções personalizadas eavançadas para a gestão de frotas e motoristas, 
         com focona redução de custos e aumento da segurança.A Fleet Solutions nasceu da visão de um 
         advogado que,durante sua graduação, trabalhou e adquiriu sólida vivênciaem transportadoras. 
         Essa experiência permitiu que eleenxergasse uma lacuna no mercado e fundasse a FleetSolutions, 
         uma empresa criada para oferecer, comexcelência, suporte e soluções para todos que vivem 
