      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={'flex-start'} align={'flex-start'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '50%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={FoiMultado} width={'150px'} />

            <TextDefault family={'Arial'} weight={'normal'} align={'justify'} top={'50px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '19px' : '19px'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '50%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            ...
            <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'50px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '19px' : '19px'}>
