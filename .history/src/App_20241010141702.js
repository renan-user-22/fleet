  ...
  return (
    <Container>
            ...
            >
              ...
              >
                <nav style={{ display: 'flex', height: '70%', width: '100%', alignItems: 'flex-end', flexDirection: 'column' }}>
                  ...
                  <LinkMenu onClick={handleClick} id="services" smooth={true} duration={500}>
      ...
      <HeroSection>
        ...
        <TextDefault color="#FFFFFF" size={isMobile ? '19px' : '24px'} left="30px">• Gestão de Multas, Controle do veículo, Gestão do motorista como controle de ponto, tempo ao volante e mais!</TextDefault>
      ...
      <ServicesSectionImg>
        ...
        <TextDefault bottom={'20px'} color="#FFFFFF" size={isMobile ? '27px' : '35px'} left={"30px"} weight={'bold'}><IoShieldCheckmark size="25px" /> Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
        <TextDefault color="#FFFFFF" size={isMobile ? '19px' : '24px'} left="30px">• Recebeu uma multa e quer recorrer?</TextDefault>

        <Box direction={'column'} width={'100%'} justify={'center'} align={'flex-start'}>
