...
const App = () => {
  ...
  return (
    <Container>
      ...
      <Box flex={'none'} direction={'column'} width={'100%'} justify={'flex-end'} align={'center'}>


        <Box flex={'none'} direction={'column'} width={areaDesktop ? '100%' : '100%'} justify={'center'} align={'flex-end'}>

          <Box flex={'none'} direction={'column'} width={'100%'} height={'100px'} style={{ background: 'linear-gradient(to right, #f5f5f5, #000000)' }} justify={'center'} align={'center'}>
