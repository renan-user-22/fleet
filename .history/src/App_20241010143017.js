    ...
    <Container>
      ...
      <ServicesSectionImg>
        ...
        <Box direction={'column'} width={areaDesktop ? '600px' : '80%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault bottom={'30px'} right={'10px'} color="#FFFFFF" size={'13px'} left="30px">Prometemos não ultilizar suas informações de contato para enviar qualquer tipo de SPAM</TextDefault>
        </Box>
