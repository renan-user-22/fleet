...
const App = () => {
  ...
  return (
    <Container>
      ...
      <Box flex={'1'} direction={'column'} width={'100%'} justify={'flex-end'} align={'center'}>

        <Box flex={'none'} direction={'column'} width={'100%'} height={'100px'} style={{ background: 'linear-gradient(to right, #f5f5f5, #000)' }} justify={'center'} align={'center'}>
