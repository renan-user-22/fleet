  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '70%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <SubmitButton onClick={(e) => sendEmail(e)}>
            <TextDefault family={'Octosquares Italic'} color="#f5f5f5" size={isMobile ? '15px' : '15px'}>FALAR com um especialista</TextDefault>
          </SubmitButton>
      ...
      <HeroSection height={areaDesktop ? '800px' : '900px'} id="fleet">
        ...
        <Box flex={'none'} width={areaDesktop ? '40%' : '90%'} direction={areaDesktop ? 'row' : 'column'} justify={'center'} align={'center'}>
