  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
          ...
          <TextDefault size={'33px'} color={'#FF4500'} weight={'bold'}>Fleet Solutions</TextDefault>
          <TextDefault size={'22px'} color={'#FFFFFF'}><IoShieldCheckmark size="25px" /> Defesa de Multas</TextDefault>
          <TextDefault ><MdOutlineContactMail size="25px" /> Suspensão de CNH</TextDefault>
          <TextDefault><TbDeviceDesktopAnalytics size="27px" /> Gestão de Frotas</TextDefault>
          <TextDefault><IoShieldCheckmark size="25px" /> Cassação de CNHSoluções</TextDefault>
          <TextDefault><IoShieldCheckmark size="25px" /> Soluções Personalizadas para empresas</TextDefault>
          <TextDefault><IoShieldCheckmark size="25px" /> Defesa de Multas</TextDefault>
          ...
          >
            <TextDefault>Saiba Mais</TextDefault>
