      ...
      <WelcomeTextWrapper>
        ...
        <Box direction={'column'} width={areaDesktop ? '600px' : '80%'} justify={'center'} align={'flex-start'}>
          ...
          >
            ...
            <option value="sem_cnh">Art. 165 - Dirigir sob a influência de álcool ou drogas (Lei Seca)</option>
            <option value="lei_seca">Art. 165-A - Recusar-se a realizar o teste do bafômetro</option>
            <option value="sinal_vermelho">Art. 175 - Participar de manobras perigosas (arrancadas bruscas ou derrapagens)</option>
            <option value="sinal_vermelho">Art. 203, V - Ultrapassar pela contramão em local com faixa contínua</option>
            <option value="sinal_vermelho">Art. 208 - Avançar o sinal vermelho do semáforo</option>
            <option value="sinal_vermelho">Art. 218, III - Exceder a velocidade em mais de 50% do limite permitido</option>
            <option value="sinal_vermelho">Art. 230, V - Conduzir veículo sem registro ou licenciamento</option>
            <option value="sinal_vermelho">Art. 252, VI - Utilizar celular durante a condução do veículo</option>
            <option value="sinal_vermelho">Art. 244, I - Conduzir motocicleta sem capacete</option>
            <option value="sinal_vermelho">Art. 261 - Acumular pontuação para suspensão da CNH</option>
            <option value="sinal_vermelho">Art. 148, §3º - Cometer infração com Permissão para Dirigir (PPD)</option>
