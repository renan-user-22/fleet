  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box direction={'column'} width={areaDesktop ? '60%' : '90%'} justify={'center'} align={'flex-start'}>

          <Box direction={'column'} width={'70%'} color={'#000'} justify={'center'} align={'center'}>
            <TextDefault bottom={'50px'} top={'50px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '35px'}>Foi Multado? </TextDefault>
          </Box>


          <TextDefault left={'30px'} color="#000" size={isMobile ? '14px' : '19px'}>Falar com um especialista</TextDefault>
        </Box>

        {areaDesktop &&
          <Box direction={'column'} width={'30%'} justify={'center'} align={'flex-start'}>
