  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} color='#ccc' direction={'column'} width={areaDesktop ? '60%' : '90%'} justify={'flex-start'} align={'flex-start'}>

          <Box flex={'none'} direction={'column'} width={'100%'} height={'100px'} color={'#000'} justify={'center'} align={'center'}>
            <TextDefault bottom={'30px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Foi Multado?</TextDefault>
          </Box>


          <TextDefault top={'30px'} left={'30px'} right={'130px'} color="#000" size={isMobile ? '14px' : '19px'}>
        ...
        {areaDesktop &&
          <Box flex={'none'} color='#ff0' width={'40%'} direction={'column'}justify={'center'} align={'center'}>
