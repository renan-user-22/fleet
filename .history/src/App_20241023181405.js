  ...
  return (
    <Container>
      ...
      <HeroSection height={areaDesktop ? '800px' : '450px'} id="fleet">
        <TextDefault align={'center'} bottom={'20px'} top={'60px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Por que a Fleet Solutions é a sua parceira ideal?</TextDefault>

        <LogoImg src={Pq} width={areaDesktop ? '80%' : '110%'} />
