...
import ImgParceira from './img/parceira.jpg';
// Ícones do layout
...
const App = () => {
  ...
  return (
    <Container>
      ...
      <HeroSection>
        <TextDefault right={'20px'} align={'right'} bottom={'30px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Por que a Fleet Solutions é a sua parceira ideal?.</TextDefault>
