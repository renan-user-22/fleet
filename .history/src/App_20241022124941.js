  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        ...
        <TextDefault bottom={'20px'} right={'10px'} color="#000" size={isMobile ? '19px' : '17px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
