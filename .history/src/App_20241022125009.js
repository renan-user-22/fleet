  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        ...
        <TextDefault bottom={'30px'} right={'10px'} color="#000" size={isMobile ? '19px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
