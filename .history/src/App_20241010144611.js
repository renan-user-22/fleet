                ...
                <nav style={{ display: 'flex', height: '70%', width: '100%', alignItems: 'flex-end', flexDirection: 'column' }}>
                  ...
                  <LinkMenu onClick={handleClick} id="services" smooth={true} duration={500}>
                    <TextDefault color="#FFFFFF" size="19px">
                      Início <HiHome style={{ marginRight: '8px', color: '#FF4500' }} />
                    </TextDefault>
                  </LinkMenu>

                  <LinkMenu href="#services">
                    <TextDefault color="#FFFFFF" size="19px">
                      Serviços <MdDesignServices style={{ marginRight: '8px', color: '#FF4500' }} />
                    </TextDefault>
                  </LinkMenu>

                  <LinkMenu href="#fleet">
                    <TextDefault color="#FFFFFF" size="19px">
                      Fleet Solutions <MdAssuredWorkload style={{ marginRight: '8px', color: '#FF4500' }} />
                    </TextDefault>
                  </LinkMenu>

                  <LinkMenu href="#contact">
                    <TextDefault color="#FFFFFF" size="19px">
                      Contato <IoLogoWhatsapp style={{ marginRight: '8px', color: '#FF4500' }} />
                    </TextDefault>
                  </LinkMenu>

                  <LinkMenu href="#acess">
                    <TextDefault weight={'bold'} color="#FFFFFF" size="17px">
                      Meu acesso <HiLockClosed size={'19px'} style={{ marginRight: '8px', color: '#FF4500' }} />
                    </TextDefault>
                  </LinkMenu>
