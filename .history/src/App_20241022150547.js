  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={'flex-start'} align={'flex-start'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '50%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={ImgEmpresas} width={'500px'} />

            <TextDefault family={'Arial'} weight={'bold'} align={'justify'} top={'20px'} bottom={'30px'} left={'100px'} right={'100px'} color="#000" size={'19px'}>
