  ...
  return (
    <Container>
      ...
      <HeroSection>
        ...
        <TextDefault right={'10px'} color="#FFFFFF" size={isMobile ? '19px' : '24px'} left="30px">• Gestão de Multas, Controle do veículo, Gestão do motorista como controle de ponto, tempo ao volante e mais!</TextDefault>
