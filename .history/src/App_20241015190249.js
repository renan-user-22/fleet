        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          >
            <motion.div
              ...
              style={{
                overflow: 'hidden',
                height: expandedCard === 1 ? 'auto' : '70px', // Controla altura diretamente
              }}
            >
              <h3>
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={expandedCard === 1 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }} // Transição suave para o parágrafo
              >
                {expandedCard === 1 && (
                  <p>
          ...
          >
            <motion.div
              ...
              style={{
                overflow: 'hidden',
                height: expandedCard === 2 ? 'auto' : '70px', // Controla altura diretamente
              }}
            >
              <h3>
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={expandedCard === 2 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }} // Transição suave para o parágrafo
              >
                {expandedCard === 2 && (
                  <p>
          ...
          >
            <motion.div
              ...
              style={{
                overflow: 'hidden',
                height: expandedCard === 3 ? 'auto' : '70px', // Controla altura diretamente
              }}
            >
              <h3>
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={expandedCard === 3 ? { opacity: 1 } : { opacity: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }} // Transição suave para o parágrafo
              >
                {expandedCard === 3 && (
                  <p>
