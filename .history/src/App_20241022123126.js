  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        ...
        <TextDefault bottom={'20px'} right={'10px'} color="#FFFFFF" size={isMobile ? '19px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
