    ...
    <Container>
      ...
      <WelcomeTextWrapper>
        <WelcomeText>
          ...
          <p><IoShieldCheckmark size="25px" /> Defesa de Multas</p>
          <p><MdOutlineContactMail size="25px" /> Suspensão de CNH</p>
          <p><TbDeviceDesktopAnalytics size="27px" /> Gestão de Frotas</p>
          <p><IoShieldCheckmark size="25px" /> Cassação de CNHSoluções</p>
          <p><IoShieldCheckmark size="25px" /> Soluções Personalizadas para empresas</p>
          <p><IoShieldCheckmark size="25px" /> Defesa de Multas</p>
