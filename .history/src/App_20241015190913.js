        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          <ServiceCard onClick={() => toggleCard(1)} zIndex={expandedCard === 1 ? 10 : 1}>
            <motion.div
              style={{
                overflow: 'hidden',
                maxHeight: expandedCard === 1 ? '300px' : '70px', // Altere '300px' para o valor desejado
              }}
              transition={{ duration: 0.5, ease: "easeInOut" }} // Transição mais suave
            >
              <h3>
          ...
          {/* Suspensão de CNH */}
          <ServiceCard onClick={() => toggleCard(2)} zIndex={expandedCard === 2 ? 10 : 1}>
            <motion.div
              style={{
                overflow: 'hidden',
                maxHeight: expandedCard === 2 ? '300px' : '70px',
              }}
          ...
          {/* Gestão de Frotas */}
          <ServiceCard onClick={() => toggleCard(3)} zIndex={expandedCard === 3 ? 10 : 1}>
            <motion.div
              style={{
                overflow: 'hidden',
                maxHeight: expandedCard === 3 ? '300px' : '70px',
              }}
              transition={{ duration: 0.5, ease: "easeInOut" }}
            >
              <h3>
