  ...
  return (
    <Container>
      ...
      <HeaderWrapper scrolled={scrolled} >
        <LogoImg width={areaDesktop ? '300px' : '200px'} left={'30px'} src={LogoMarca} alt="Logo da Fleet Solutions" />
      ...
      <WelcomeTextWrapper width={areaDesktop ? '50%' : '70%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault top={'15px'} bottom={'25px'} right={'10px'} color="#FFFFFF" size={'13px'} left="20px">Prometemos não ultilizar suas informações de contato para enviar qualquer tipo de SPAM.</TextDefault>
