  ...
  return (
    <Container>
      ...
      <HeaderWrapper scrolled={scrolled} >
        <LogoImg width={'300px'} left={'30px'} src={LogoMarca} alt="Logo da Fleet Solutions" />
      ...
      <WelcomeTextWrapper>
        <TextDefault bottom={'10px'} right={'10px'} color="#FFFFFF" size={isMobile ? '27px' : '35px'} left="30px"><IoShieldCheckmark size="25px" /> Precisando de assistência especializada?</TextDefault>
        <TextDefault bottom={'20px'} right={'10px'} color="#FFFFFF" size={isMobile ? '19px' : '24px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault bottom={'20px'} right={'10px'} color="#FFFFFF" size={isMobile ? '19px' : '24px'} left={"30px"} weight={'bold'}>Como podemos te ajudar?</TextDefault>
          <SelectField
            name="option"
          ...
          <SubmitButton onClick={(e) => sendEmail(e)}>Falar com um especialista</SubmitButton>
