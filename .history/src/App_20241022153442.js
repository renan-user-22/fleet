    ...
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={'column'} width={areaDesktop ? '60%' : '100%'} justify={'flex-start'} align={'center'}>
          ...
          <TextDefault family={'Century Gothic'} align={'justify'} top={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '17px' : '19px'}>
        ...
        <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={areaDesktop ? 'space-around' : 'center'} align={'center'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '40%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            ...
            <TextDefault family={'Century Gothic'} weight={'normal'} align={'justify'} top={'22px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={'21px'}>
