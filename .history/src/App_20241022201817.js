...
const App = () => {
  ...
  return (
    <Container>
      ...
      <Box flex={'none'} direction={'column'} width={'100%'} height={'200px'} style={{ background: 'linear-gradient(to right, #eebe2c, #f6382a)' }} justify={'center'} align={'center'}>
        <TextDefault align={'center'} bottom={'30px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Por que a Fleet Solutions é a sua parceira ideal ?</TextDefault>
      </Box>


      <Box width={'100%'}>

        <LogoImg src={ImgParceira} width={'100%'} />
