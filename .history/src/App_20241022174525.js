...
const App = () => {
  ...
  return (
    <Container>
      ...
      <Box flex={'none'} direction={'column'} width={'100%'} justify={'center'} align={'flex-end'}>
        ...
        <Box flex={'none'} direction={'column'} width={areaDesktop ? '60%' : '100%'} justify={'flex-end'} align={'center'}>
