    ...
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '70%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault family={'Octosquares Italic'} bottom={'30px'} right={'10px'} color="#000" size={isMobile ? '14px' : '18px'} left={"30px"}>PREENCHA O FORMULÁRIO ABAIXO E FALE COM O ESPECIALISTA AGORA!</TextDefault>
        </Box>
