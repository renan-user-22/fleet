    ...
    <Container>
      ...
      <FleetSection id="fleet">
        ...
        <Box direction={areaDesktop ? 'row' : 'column'} >
          ...
          <Box direction={'column'} justify={'center'} align={'center'} leftSpace={'30px'}>
            <motion.h1
              initial={{ opacity: 0, y: -50 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1 }}
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1 }}
              style={{ marginRight: '17px', marginRight:'17px', textAlign:'center', fontSize: '19px', fontFamily: 'Century Gothic' }}
            >
