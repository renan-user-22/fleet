    ...
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '50%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault family={'Octosquares'} bottom={'30px'} right={'10px'} color="#000" size={isMobile ? '14px' : '19px'} left={"30px"}>P R E E N C H A  O  F O R M U L Á R I O  A B A I X O  E  F A L E  C O M  O  E S P E C I A L I S T A   A G O R A ! </TextDefault>
        </Box>
