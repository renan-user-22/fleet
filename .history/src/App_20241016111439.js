    ...
    <Container>
      ...
      <WelcomeTextWrapper>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault top={'15px'} bottom={'15px'} right={'10px'} color="#FFFFFF" size={'13px'}>Prometemos não ultilizar suas informações de contato para enviar qualquer tipo de SPAM.</TextDefault>
