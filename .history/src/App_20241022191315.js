  ...
  return (
    <Container>
      ...
      <FleetSection id="fleet">
        <Box direction={areaDesktop ? 'row' : 'column'} justify={'center'} align={'center'} width={'90%'}>

          {areaDesktop &&
            <Box flex={'none'} width={'50%'} direction={'column'} justify={'center'} align={'center'}>
              <LogoImg src={Ns} width={'80%'} />
            </Box>
          }
          ...
          <Box flex={'none'} width={'50%'} direction={'column'} justify={'center'} align={'center'}>
            ...
            <Box flex={'none'} width={'110%'} direction={'row'}>
              <SubmitButtonTwo>
            ...
            <Box flex={'none'} width={'105%'} direction={'row'}>
              <SubmitButtonTwo>
               Consultoria preventiva e personalizada
              </SubmitButtonTwo>
