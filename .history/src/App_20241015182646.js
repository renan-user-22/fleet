...
const App = () => {
  ...
  const toggleCard = (cardIndex) => {
    if (expandedCard === cardIndex) {
      setExpandedCard(null); // Fecha o card se clicar novamente
    } else {
      setExpandedCard(cardIndex); // Abre o card clicado
    }
  };
    ...
    <Container>
      ...
      <ServicesSection id="services">
        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          <ServiceCard onClick={() => toggleCard(1)} style={{ zIndex: expandedCard === 1 ? 10 : 1 }}>
            <motion.div
              initial={{ height: expandedCard === 1 ? 'auto' : '150px' }}
              animate={{ height: expandedCard === 1 ? 'auto' : '150px' }}
            ...
            >
              ...
              >
                ...
                Receber uma multa de trânsito pode ser uma situação desagradável, mas é
                fundamental lidar com ela da melhor forma possível. Na Fleet Solutions,
                oferecemos todo o suporte necessário para buscar a anulação da penalidade
                de forma eficiente e estratégica. Nossa equipe especializada elabora
                recursos totalmente personalizados em cada fase do processo, desde a
                Defesa Prévia até os recursos junto à JARI e ao CETRAN, garantindo
                que cada detalhe seja considerado. Nosso objetivo é assegurar que
                seus direitos sejam respeitados e que você tenha a melhor chance
