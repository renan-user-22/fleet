    ...
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '70%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          <TextDefault family={'Octosquares Bold'} bottom={'10px'} right={'10px'} color="#000" size={isMobile ? '22px' : '33px'} left="30px">Precisando de assistência especializada?</TextDefault>
