  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
          ...
          <TextDefault size={'22px'} color={'#FFFFFF'} top={'10px'} bottom={'25px'}><IoShieldCheckmark size="25px" /> Soluções Personalizadas para empresas</TextDefault>
          ...
          >
            <TextDefault size={'17px'} color={'#FFFFFF'} ><FaWhatsapp style={{ marginRight: '8px' }} /> Saiba Mais</TextDefault>
