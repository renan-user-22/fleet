      ...
      <WelcomeTextWrapper>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          >
            ...
            <option value="165">Art. 165 - Dirigir sob a influência de álcool ou drogas (Lei Seca)</option>
            <option value="165_A">Art. 165-A - Recusar-se a realizar o teste do bafômetro</option>
            <option value="175">Art. 175 - Participar de manobras perigosas (arrancadas bruscas ou derrapagens)</option>
            <option value="203">Art. 203, V - Ultrapassar pela contramão em local com faixa contínua</option>
            <option value="208">Art. 208 - Avançar o sinal vermelho do semáforo</option>
            <option value="218">Art. 218, III - Exceder a velocidade em mais de 50% do limite permitido</option>
            <option value="230">Art. 230, V - Conduzir veículo sem registro ou licenciamento</option>
            <option value="252">Art. 252, VI - Utilizar celular durante a condução do veículo</option>
            <option value="244">Art. 244, I - Conduzir motocicleta sem capacete</option>
            <option value="261">Art. 261 - Acumular pontuação para suspensão da CNH</option>
            <option value="148">Art. 148, §3º - Cometer infração com Permissão para Dirigir (PPD)</option>
            <option value="outros">Outros</option>
          </SelectField>

          <TextDefault top={'15px'} bottom={'15px'} right={'10px'} color="#FFFFFF" size={'13px'} left="30px">Prometemos não ultilizar suas informações de contato para enviar qualquer tipo de SPAM.</TextDefault>

          <SubmitButton onClick={(e) => sendEmail(e)}>Solicitar Atendimento</SubmitButton>
        ...
        <Box direction={areaDesktop ? 'row' : 'column'} >
          ...
          <Box direction={'column'} justify={'center'} align={'center'}>
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1 }}
              style={{ marginRight: '17px', marginLeft: '17px', textAlign: 'center', fontSize: '19px', fontFamily: 'Century Gothic' }}
            >
