  ...
  return (
    <Container>
      ...
      <HeaderWrapper scrolled={scrolled}>
        ...
        {areaDesktop &&
          <NavBar style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            ...
            >
              Consulte o andamento dos
              seus serviços na Fleet Solutions
            </motion.button>
          </NavBar>
        }
      ...
      <WelcomeTextWrapper>
          ...
          <TextDefault size={'22px'} color={'#FFFFFF'} top={'10px'} bottom={'10px'}><IoShieldCheckmark size="25px" /> Cassação de CNH</TextDefault>
          <TextDefault size={'22px'} color={'#FFFFFF'} top={'10px'} bottom={'10px'}><IoShieldCheckmark size="25px" /> Soluções Personalizadas para empresas</TextDefault>
          ...
          >
            <TextDefault size={'17px'} color={'#FFFFFF'} >Saiba Mais <FaWhatsapp style={{ marginRight: '8px' }} /></TextDefault>
