...
const App = () => {
  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
<TextDefault bottom={'30px'} right={'10px'} color="#FFFFFF" size={isMobile ? '27px' : '35px'} left="30px">• Recebeu uma multa e quer recorrer?</TextDefault>
        <TextDefault bottom={'20px'} right={'10px'} color="#FFFFFF" size={isMobile ? '19px' : '24px'} left={"30px"} weight={'bold'}><IoShieldCheckmark size="25px" /> Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
