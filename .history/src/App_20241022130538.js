  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '50%' : '85%'}>
        <TextDefault bottom={'10px'} color="#f5f5f5" size={isMobile ? '20px' : '35px'} left="30px">Precisando de assistência especializada?</TextDefault>
        <TextDefault bottom={'30px'} color="#f5f5f5" size={isMobile ? '14px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
