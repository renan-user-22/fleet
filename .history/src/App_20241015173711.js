...
const App = () => {
  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        <TextDefault bottom={'30px'} right={'10px'} color="#FFFFFF" size={isMobile ? '27px' : '35px'} left="30px"><IoShieldCheckmark size="25px" /> Recebeu uma multa e quer recorrer?</TextDefault>
