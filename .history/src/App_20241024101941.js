    ...
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '70%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault family={'Octosquares Extra Light'} bottom={'20px'} right={'10px'} color="#000" size={isMobile ? '14px' : '19px'} left={"30px"}>PREENCHA O FORMULÁRIO ABAIXO E FALE COM O ESPECIALISTA AGORA!</TextDefault>
        </Box>
