  ...
  return (
    <Container>
      ...
      <ServicesSectionImg>
        ...
        <TextDefault bottom={'30px'} bottom={'20px'} color="#FFFFFF" size={isMobile ? '27px' : '35px'} left={"30px"} weight={'bold'}><IoShieldCheckmark size="25px" /> Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
