        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard === 1 ? 'auto' : '70px', // Apenas o card 1 expande
              }}
            ...
            >
              ...
              {expandedCard === 1 && ( // Mostra o parágrafo apenas se o card 1 estiver expandido
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard === 2 ? 'auto' : '70px', // Apenas o card 2 expande
              }}
              transition={{ duration: 0.5 }}
            ...
            >
              ...
              {expandedCard === 2 && ( // Mostra o parágrafo apenas se o card 2 estiver expandido
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.3 }} // Texto aparece após a expansão
                >
                  Evite a suspensão da sua CNH com nossas soluções personalizadas...
                  {/* Resto do texto */}
                </motion.p>
              )}
            </motion.div>
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard === 3 ? 'auto' : '70px', // Apenas o card 3 expande
              }}
              transition={{ duration: 0.5 }}
            ...
            >
              ...
              {expandedCard === 3 && ( // Mostra o parágrafo apenas se o card 3 estiver expandido
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.3 }} // Texto aparece após a expansão
...
A gestão de frotas exige atenção cuidadosa à operação e à conformidade com as regras de trânsito. Na Fleet Solutions, ajudamos sua empresa a monitorar multas, documentos e a conformidade legal dos motoristas. Nosso objetivo é reduzir custos operacionais e melhorar a segurança da frota, oferecendo soluções que mantêm seus veículos e motoristas em conformidade, enquanto minimizamos riscos no trânsito. Com nossa abordagem personalizada, sua frota operará de maneira mais eficiente e segura.
