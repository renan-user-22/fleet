...
const App = () => {
  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '60%' : '85%'}>

        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          <TextDefault family={'Octosquares Bold'} bottom={'10px'} right={'10px'} color="#000" size={isMobile ? '22px' : '35px'} left="30px">Precisando de assistência especializada?</TextDefault>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <SubmitButton onClick={(e) => sendEmail(e)}>
            <TextDefault family={'Octosquares'} color="#f5f5f5" size={isMobile ? '19px' : '19px'}>Falar com um especialista</TextDefault>
          </SubmitButton>
