...
const App = () => {
  ...
  return (
    <Container>
      ...
      <HeroSection>
        <TextDefault right={'20px'} align={'right'} bottom={'10px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '21px' : '35px'}>Por que a Fleet Solutions é a sua parceira ideal?.</TextDefault>
