  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box color='#ccc' direction={'column'} width={areaDesktop ? '80%' : '90%'} justify={'flex-start'} align={'flex-start'}>
        ...
        {areaDesktop &&
          <Box flex={'none'} color='#ff0' width={'20%'} direction={'column'}justify={'center'} align={'center'}>
