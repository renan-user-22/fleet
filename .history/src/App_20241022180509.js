    ...
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={'column'} width={areaDesktop ? '60%' : '100%'} justify={'flex-start'} align={'center'}>
          ...
          <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'150px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '19px' : '29px'}>
      ...
      <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={areaDesktop ? 'space-around' : 'center'} align={'center'}>
      ...
      <Box flex={'1'} direction={'column'} width={'100%'} justify={'flex-start'} align={'flex-start'} topSpace={'50px'}>

        <Box flex={'none'} direction={'column'} width={'100%'} justify={'flex-start'} align={'flex-end'} topSpace={'30px'} bottomSpace={'50px'}>
          <Box flex={'none'} direction={'column'} width={'70%'} height={'100px'} style={{ background: 'linear-gradient(to right, #f5f5f5, #000)' }} justify={'center'} align={'center'}>
            <TextDefault bottom={'30px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Evite perder dinheiro.</TextDefault>
          </Box>
        </Box>
        ...
        <Box flex={'1'} direction={'row'} width={'100%'} justify={'flex-start'} align={'flex-start'}>
          ...
          <Box direction={'column'} justify={'center'} align={'flex-end'} color='#ccc'>
            <TextDefault family={'Century Gothic'} align={'justify'} top={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '18px' : '21px'}>
            ...
            <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'150px'} bottom={'30px'} left={'30px'} right={'90px'} color="#000" size={isMobile ? '19px' : '29px'}>
