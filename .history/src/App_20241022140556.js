  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={'column'} width={areaDesktop ? '60%' : '100%'} justify={'flex-start'} align={'flex-start'}>
          ...
          <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'50px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '19px' : '19px'}>
