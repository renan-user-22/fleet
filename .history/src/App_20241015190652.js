      ...
      <ServicesSection id="services">
        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          <ServiceCard
            ...
            style={{ overflow: 'hidden', maxHeight: expandedCard === 1 ? 'auto' : '70px' }} // Controla altura diretamente
          >
            <motion.div
          ...
          <ServiceCard
            ...
            style={{ overflow: 'hidden', maxHeight: expandedCard === 2 ? 'auto' : '70px' }} // Controla altura diretamente
          >
            <motion.div
          ...
          <ServiceCard
            ...
            style={{ overflow: 'hidden', maxHeight: expandedCard === 3 ? 'auto' : '70px' }} // Controla altura diretamente
          >
            <motion.div
              transition={{ duration: 0.5 }}
