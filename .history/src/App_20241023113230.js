...
const App = () => {
  ...
  return (
    <Container>
      ...
      <HeroSection height={areaDesktop ? '800px' : '400px'} id="fleet">
        <TextDefault align={'center'} bottom={'10px'} top={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Por que a Fleet Solutions é a sua parceira ideal?</TextDefault>

        <LogoImg src={Pq} width={areaDesktop ? '70%' : '110%'} />

        <LogoImg src={LogoMarca} width={areaDesktop ? '100px' : '50px'} />
      </HeroSection>
