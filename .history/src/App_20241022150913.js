  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={'center'} align={'center'}>


          <Box flex={'none'} width={areaDesktop ? '40%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={ImgMotoristas} width={'500px'} />
          ...
          <Box flex={'none'} width={areaDesktop ? '40%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            ...
            <TextDefault family={'Arial'} weight={'normal'} align={'justify'} top={'20px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={'19px'}>
