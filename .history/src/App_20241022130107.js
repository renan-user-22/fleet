  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '50%' : '70%'}>
        ...
        <TextDefault bottom={'30px'} right={'10px'} color="#f5f5f5" size={isMobile ? '15px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
