  ...
  return (
    <Container>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={'space-around'} align={'center'}>


          <Box flex={'none'} width={areaDesktop ? '30%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg top={'50px'} src={ImgMotoristas} width={'500px'} />

            <TextDefault family={'Arial'} weight={'normal'} align={'justify'} top={'20px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={'21px'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '30%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg top={'50px'} src={ImgEmpresas} width={'500px'} />
