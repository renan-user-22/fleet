...
const App = () => {
  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        <TextDefault bottom={'10px'} right={'10px'} color="#f5f5f5" size={isMobile ? '25px' : '35px'} left="30px">Precisando de assistência especializada?</TextDefault>
        <TextDefault bottom={'30px'} right={'10px'} color="#f5f5f5" size={isMobile ? '19px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
