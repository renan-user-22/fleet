...
const App = () => {
  ...
  const toggleCard = (cardId) => {
    // Alterna a expansão apenas do card clicado
        ...
        <div className="cards" style={{ marginTop: '70px' }}>
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard == 1 ? 'auto' : '70px', // Expande apenas este card
              }}
            ...
            >
              ...
              {expandedCard === 1 && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.3 }} // Texto aparece apenas se expandido
                >
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard == 2 ? 'auto' : '70px', // Expande apenas este card
              }}
              transition={{ duration: 0.5 }}
          ...
          >
            <motion.div
              initial={{ height: '70px' }}
              animate={{
                height: expandedCard == 3 ? 'auto' : '70px', // Expande apenas este card
              }}
              transition={{ duration: 0.5 }}
