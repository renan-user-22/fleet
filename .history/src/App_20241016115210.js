  ...
  return (
    <Container>
      ...
      <FleetSection id="fleet">
        ...
        <Box direction={areaDesktop ? 'row' : 'column'} width={'100%'}  align={'center'} justify={'center'}>
          ...
          <Box direction={'column'} justify={'center'} align={'center'}>
            <motion.h1
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1 }}
              style={{ color:'#f5f5f5', marginRight: '17px', marginLeft: '17px', textAlign: 'center', fontFamily: 'Century Gothic' }}
            >
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1 }}
              style={{ color:'#f5f5f5', marginRight: '17px', marginLeft: '17px', textAlign: 'center', fontSize: '19px', fontFamily: 'Century Gothic' }}
            >
