    ...
    <Container>
      ...
      <WelcomeTextWrapper width={areaDesktop ? '50%' : '85%'}>
        ...
        <Box direction={'column'} width={areaDesktop ? '90%' : '100%'} justify={'center'} align={'flex-start'}>
          ...
          <TextDefault bottom={'20px'} color="#f5f5f5" size={isMobile ? '14px' : '19px'} left={"27px"}>Como podemos te ajudar?</TextDefault>
      ...
      <ServicesSection>
        ...
        <Box flex={'none'} direction={'column'} width={areaDesktop ? '60%' : '100%'} justify={'flex-start'} align={'center'}>
          ...
          <Box flex={'none'} direction={'column'} width={'100%'} height={'100px'} style={{ background: 'linear-gradient(to right, #000, #f5f5f5)' }} justify={'center'} align={'center'}>
            <TextDefault bottom={'30px'} top={'30px'} left={'30px'} color="#f5f5f5" size={isMobile ? '22px' : '45px'}>Foi Multado?</TextDefault>
          </Box>


          <TextDefault align={'justify'} top={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '17px' : '19px'}>
          ...
          <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'50px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={isMobile ? '19px' : '23px'}>
        ...
        {areaDesktop &&
          <Box flex={'none'} width={'40%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={FoiMultado} width={'400px'} />
          </Box>
        }
      ...
      <ServicesSection>
        <Box flex={'none'} direction={'column'} width={'100%'} height={'100px'} style={{ background: 'linear-gradient(to right, #eebe2c, #f6382a)' }} justify={'center'} align={'center'}>
        ...
        <Box color={'#ff0'} flex={'none'} direction={areaDesktop ? 'row' : 'column'} width={'100%'} justify={'flex-start'} align={'flex-start'}>

          <Box flex={'none'} width={areaDesktop ? '50%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={ImgMotoristas} width={'150px'} />

            <TextDefault family={'Arial'} weight={'normal'} align={'justify'} top={'50px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={'19px'}>
          ...
          <Box flex={'none'} width={areaDesktop ? '50%' : '100%'} direction={'column'} justify={'center'} align={'center'}>
            <LogoImg src={ImgEmpresas} width={'150px'} />

            <TextDefault family={'Arial'} weight={'bold'} align={'center'} top={'50px'} bottom={'30px'} left={'30px'} right={'30px'} color="#000" size={'19px'}>
