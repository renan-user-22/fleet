...
const App = () => {
  ...
  return (
    <Container>
      ...
      <WelcomeTextWrapper>
        <TextDefault bottom={'10px'} right={'10px'} color="#FF4500" size={isMobile ? '25px' : '30px'} left="30px">Precisando de assistência especializada?</TextDefault>
        <TextDefault bottom={'20px'} right={'10px'} color="#000" size={isMobile ? '19px' : '19px'} left={"30px"}>Preencha o formulário abaixo e fale com o especialista agora!</TextDefault>
